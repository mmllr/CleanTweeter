...
func createUsers() -> [User] {
	...
	let users = [
		User(name: "Tim Cook", followedUsers: ["Jony Ive", "Craig Federighi", "Eddy Cue"], tweets: [
			...
			], avatar: "http://images.apple.com/leadership/tim-cook/bio/image_large_2x.png"),
		User(name: "Craig Federighi", followedUsers: ["Tim Cook", "Jony Ive"], tweets: [
			...
			], avatar: "http://images.apple.com/leadership/craig-federighi/bio/image_large_2x.png"),
		User(name: "Jony Ive", followedUsers: ["Tim Cook"], tweets: [
			...
			], avatar: "http://images.apple.com/leadership/jonathan-ive/bio/image_large_2x.png"),
		User(name: "Eddy Cue", followedUsers: ["Tim Cook", "Jony Ive", "Craig Federighi"], tweets: [
			...
			], avatar: "http://images.apple.com/leadership/eddy-cue/bio/image_large_2x.png")
	]
	return users
}
